package com.example.wsmeverylisten.annotation.aspect;
...
//    @Pointcut("within(com.example.wsmeverylisten.service.UserService.*)")
    @Pointcut("within(@com.example.wsmeverylisten.annotation.Metrics *)")
